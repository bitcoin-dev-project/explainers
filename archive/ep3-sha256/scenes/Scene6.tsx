...
export function Scene6() {
  return (
    ...
    >
      ...
      >
        Today we'll focus on the first step:
      </motion.p>
      ...
      >
        ...
        {/* Padding — highlighted in orange */}
        <motion.div
          className="px-[2.5vw] py-[2vh] rounded-[0.4vw] text-[1.6vw] font-bold"
          style={{
